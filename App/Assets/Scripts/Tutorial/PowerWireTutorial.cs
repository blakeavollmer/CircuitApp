...
namespace BV.Hololens.EngineeringApp.Classes
{
    ...
    public class PowerWireTutorial : Tutorial, IInputClickHandler
    {
        ...
        IEnumerator Waiting9()
        {
            ...
            if (changeText.text == "You have completed your first circuit. The electrons flow from the negative source to the positive source. This is what we call an electric current.")
        ...
        IEnumerator Waiting10()
        {
            ...
            if (changeText.text == "The current is equal to voltage over resistance. Our voltage is 3, and our resistance is 270 ohm. This means our current is .01 amps.")
        ...
        IEnumerator Waiting12()
        {
            ...
            if (changeText.text == "We can also calculate Ohm’s Law. Ohm’s Law states that the electrical current flowing through a fixed linear resistance is directly proportional to the voltage applied across it and is also inversely proportional to the resistance.")
